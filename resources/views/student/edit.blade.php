    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('student.update') }}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Last name" value="{{ $student->last_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="class_id" class="form-control" name="class_id">
                                        ...
                                        <option value="{{ $classDivision->id }}" {{ $classDivision->id == $student->class_id ? 'selected' : '' }}>
                                            {{ $classDivision->class_name }} / {{ $classDivision->division }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="roll_number" class="form-control" name="roll_number" placeholder="Student Roll No" value="{{ $student->roll_number }}">
                                </div>
                            </div>
                        </div>
                    </div>
